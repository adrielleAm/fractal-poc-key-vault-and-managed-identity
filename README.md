...
![Spring boot initial configuration](https://github.com/dtidigitalcrafters/key-vault-and-managed-identity/blob/master/resources/images/spring-boot-initial-config.png?raw=true)
